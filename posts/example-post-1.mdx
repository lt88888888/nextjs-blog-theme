---
type: Post
title: Cursor Prompting HandBook
description: ''
date: '2025-01-06'
---
You have an Idea to turn into Software?
Use CodeGuide to turn that idea into proper developments documentation for AI coding models.
AI Coding = Detailed Context + Clear Prompting.
Build web apps, mobile apps, landing pages, extentions..
